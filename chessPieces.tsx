...
export const ChessPiece: React.FC<PieceProps> = ({ piece, color, className = 'w-full h-full' }) => {
  const isWhite = color === 'w';

  // Crisp standard SVG chess piece paths
  switch (piece) {
    case 'p':
      return (
        ...
        <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
          {isWhite ? (
            ...
            >
              ...
              <circle cx="14" cy="15" r="1" fill="#262626" />
            </g>
          ) : (
            <g
              fill="#1e1e1e"
        ...
        <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
          {isWhite ? (
            ...
            >
              ...
              <path d="M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18" />
            </g>
          ) : (
            <g
              fill="#1e1e1e"
        ...
        <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
          {isWhite ? (
            ...
            >
              ...
              <path d="M 12.5,31.5 A 35,35 1 0 1 32.5,31.5" />
              <path d="M 11.5,34.5 A 35,35 1 0 1 33.5,34.5" />
            </g>
          ) : (
            <g
              fill="#1e1e1e"
        ...
        <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
          {isWhite ? (
            ...
            >
              ...
              <path d="M 11.5,37 C 17,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 12.5,37" />
